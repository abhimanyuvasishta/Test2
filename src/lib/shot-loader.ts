...
export function shotRemoteUrl(prompt: string, seed: number): string {
  ...
  return `https://image.pollinations.ai/prompt/${q}?width=1280&height=720&nologo=true&enhance=true&seed=${seed}`;
}
